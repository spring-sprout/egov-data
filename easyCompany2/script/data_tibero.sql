...
insert into RTETNMBER(MBER_NO,MBER_ID,NM,PASSWORD,EMAIL,TELNO,MBTLNUM,DETAIL_ADRES,LAST_CHANGE_DT,MNGR_SE,ZIP,ADRES) values ('MEMBER-0000000000001','admin','관리자','21232f297a57a5a743894a0e4a801fc3','admin@easyCompany2.com','070-777-7777','010-123-4567','',to_date('11/08/16','RR/MM/DD'),'CODE01','134000','서울시 송파구 풍납동');
insert into RTETNMBER(MBER_NO,MBER_ID,NM,PASSWORD,EMAIL,TELNO,MBTLNUM,DETAIL_ADRES,LAST_CHANGE_DT,MNGR_SE,ZIP,ADRES) values ('MEMBER-0000000000002','user','일반사용자','ee11cbb19052e40b07aac0ca060c23ee','user@easyCompany2.com','02-413-0000','010-987-6543','',to_date('11/08/26','RR/MM/DD'),'CODE02','111111','서울시 중구 무교동');
...
insert into RTETNBBS (NO,REGIST_DT,CN,SJ,MBER_NO,MBER_ID) values ('BOARD-00000000000001',to_date('11/08/30','RR/MM/DD'),'입찰구분: 공사  
입찰종류: 전자입찰  
공고번호: 20110901535  
...
insert into RTETNBBS (NO,REGIST_DT,CN,SJ,MBER_NO,MBER_ID) values ('BOARD-00000000000002',to_date('11/09/01','RR/MM/DD'),'구분: [폐기물수집.운반] [폐기물처리업] [폐기물종합처리업] 
지역제한: 전국 
