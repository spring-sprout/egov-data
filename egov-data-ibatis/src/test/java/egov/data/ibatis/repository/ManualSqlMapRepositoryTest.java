...
public class ManualSqlMapRepositoryTest {
	...
	public void Repository가_올바르게_생성되었는가() {
		...
		assertThat(repository.getSqlMapClient(), not(sqlMapClient));
		assertThat(repository.getSqlMapClient(), is(anotherSqlMapClient));
	}
